...
@Component({
  selector: 'ngx-filter-manage-library',
  templateUrl: './filter-manage-library.component.html',
  styleUrls: ['./filter-manage-library.component.scss']
})
export class FilterManageLibraryComponent implements OnInit, OnDestroy {
  ...
  constructor(protected ref: NbDialogRef<any>, private translate: TranslateService, 
    private readonly _eventService: EventAggregatorService, private libraryservice: LibraryService, private designerService: DesignerService) { }
  ...
  ngOnInit() {
    ...
    this.libraryservice.getManageLIbraryFilter(this.managelibrary).subscribe((response: BlockFilterDataModel) => {
