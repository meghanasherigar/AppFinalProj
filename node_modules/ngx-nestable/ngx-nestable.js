...
const hasPointerEvents = (function () {
    const /** @type {?} */ el = document.createElement('div'), /** @type {?} */ docEl = document.documentElement;
...
class NestableComponent {
    ...
    _move(event) {
        ...
        const /** @type {?} */ pointElRoot = _closest(this.pointEl, `.${this.options.rootClass}`), /** @type {?} */ isNewRoot = pointElRoot
